...
[水質](wq.md)(fn_wq)が有効なら、地下水中の溶存物質も側方流動と
一緒に移動し、湧出時にその濃度のまま地表水へ戻ります(吸着による
移動の遅れは水質側の wq_rg で与えます)。
...
examples/sewer_hybrid/gen_data.py(幹線 D=1.0 m と枝管 D=0.4 m の換算・
