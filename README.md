...
- **海水浸入・塩水くさび**: 淡塩2層(鋭利界面)近似で、帯水層への
  海水の浸入・後退(Ghyben-Herzberg)、淡水レンズ、高潮・津波で遡上
  した海水の行き先までを、地表水・地下水と同じ格子で扱います
  (2026-08 プロトタイプ。混合・汽水は扱いません → できないこと)。
- **都市の内水(下水道の排水・噴出)**: 下水道網をセル別容量+8方向
  通水能の等価連続体(人工の被圧層)として、地表氾濫と単一の時間発展で
  連成。雨水枡の呑み込み、満管の圧力流(サーチャージ)、マンホールから
  の噴出までを扱います(2026-08 プロトタイプ。適用限界は下記
  「できないこと」参照)。岩盤亀裂網・カルスト・農地暗渠にも同じ
  仕組みが使えます。
...
- **火山災害(密度流系)**: 山体崩壊(岩屑なだれ)・火砕流・火山泥流
  ...
  一定停止応力則。Titan2D / VolcFlow と同水準)。噴火供給→流下→
...
- **下水道管網の個別管路・制御運転** — 管路 1 本 1 本の追跡や、
  ...
  SWMM 等の管網モデルの領域です(構造物単体は内部水理構造物で、
...
- **深部地下水** — ENCflow の地下水は流出解析のための浅層2層
  ...
  表す人工被圧で、天然の広域被圧帯水層や井戸単位の地下水資源解析は
  3次元地下水モデルの領域です。
