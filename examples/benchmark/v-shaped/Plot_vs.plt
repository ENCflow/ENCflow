...
set xlabel '時間 (分)'
set ylabel '流量 (m^3/s)'
set key font 'Arial,10' spacing 1.2
plot 'result/flux01.txt' us 1:2 w l lw 1.0                  lc 'red'      title '流域出口', \
     ...
     'analytical.txt' us 1:3 pt 6 ps 2 lw 0.5 lc 'black' title '流域出口(理論値)', \
     'analytical.txt' us 1:4 pt 2 ps 2 lw 0.5 lc 'black' title '流域中央(理論値)', \
     'analytical.txt' us 1:2 pt 4 ps 2 lw 0.5 lc 'black' title '斜面下端(理論値)'
pause -1
