module m_swflow_dev
  ...
  !--------------------------------------------------------------------
  public :: m_swflow_dev_init
  public :: m_swflow_dev_calc
  public :: m_swflow_dev_dispose
...
! ENCの初期化
!----------------------------------------------------------------------
subroutine m_swflow_dev_init(p, g, s)
  type(t_sysparam), intent(in) :: p
  type(t_geoinfo), intent(in) :: g
  type(t_state), intent(in) :: s
...
! ENCの計算
!----------------------------------------------------------------------
subroutine m_swflow_dev_calc(p, g, b, s, ierror)
  type(t_sysparam), intent(in) :: p
  type(t_geoinfo), intent(in) :: g
