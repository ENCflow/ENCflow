module list_gwflow
  ...
  type t_list_gwflow
    ...
    integer :: f_gwfrost = 0         ! 凍土による浸透抑制(0:なし, 1:有効。
                                     ! &list_gwflow_frost。要 fn_meteo)。無効時は資源を確保しない
