...
わかります(以降の水深分布図は、水深 0 を白・深い場所を暖色として、
数 cm の斜面流から 10 m 級の湛水までを対数カラーバーで示します)。同梱の gnuplot スクリプトで、4 時刻の水深分布を 1 画面に
...
対し、raw では水が流域中の窪地に捕まってしまい(散在する赤い点)、
河川網がぶつ切りになります。流速の最大値も末期には 1.5 m/s 程度まで落ち、流域全体で
流れが死んでいることがわかります。
