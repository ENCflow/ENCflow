...
わかります。同梱の gnuplot スクリプトで、4 時刻の水深分布を 1 画面に
...
図のカラーバーは対数で、数 cm の斜面流から 10 m 級の湛水までを
1 枚に収めています。filled では支流が本川に集まり、出口へ向かう
一本の河川網が描かれるのに対し、raw では水が流域中の窪地に捕まって
しまい(散在する赤い点)、河川網がぶつ切りになります。流速の最大値も末期には 1.5 m/s 程度まで落ち、流域全体で
流れが死んでいることがわかります。
